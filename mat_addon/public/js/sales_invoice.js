...
frappe.ui.form.on('Sales Invoice', {
    contract: function (frm, cdt, cdn) {
        ...
        frappe.call({
            method: 'mat_addon.mat_addon.doctype.sales_invoice.sales_invoice.fetch_item_code',
            args: {
...
frappe.ui.form.on('Sales Invoice Item', {
    item_code: function (frm, cdt, cdn) {
        var d = locals[cdt][cdn];
        frappe.call({
            method: 'mat_addon.mat_addon.doctype.sales_invoice.sales_invoice.uom_fetch',
            args: {
                name: d.item_code,
            },
            callback: function (r) {
...
frappe.ui.form.on('Sales Invoice Item', "uom",function(frm,cdt,cdn){
        var d = locals[cdt][cdn];
        frappe.call({
            method:"mat_addon.mat_addon.doctype.sales_invoice.sales_invoice.fetch_item_rate",
            args:{
                uom:d.uom,
...
frappe.ui.form.on('Sales Invoice Item', "item_code",function(frm,cdt,cdn){
        ...
        frappe.call({
            method:"mat_addon.mat_addon.doctype.sales_invoice.sales_invoice.fetch_item_name",
            args:{
                item_code:d.item_code
            },
            callback:function(r){
